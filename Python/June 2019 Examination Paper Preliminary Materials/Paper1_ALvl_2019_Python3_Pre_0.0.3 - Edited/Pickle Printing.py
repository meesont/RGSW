...
def LoadGame(Filename, Characters, Items, Places):
  try:
    ...
    print("NoOfCharacters=", NoOfCharacters)
    for Count in range(NoOfCharacters):
      TempCharacter = Character()
      TempCharacter.ID = pickle.load(f)
      print("TempCharacter.ID=", TempCharacter.ID)
      TempCharacter.Name = pickle.load(f)
      print("TempCharacter.Name=", TempCharacter.Name)
      TempCharacter.Description = pickle.load(f)
      print("TempCharacter.Description=", TempCharacter.Description)
      TempCharacter.CurrentLocation = pickle.load(f)
      print("TempCharacter.CurrentLocation=", TempCharacter.CurrentLocation)
      Characters.append(TempCharacter)
    NoOfPlaces = pickle.load(f)
    print("NoOfPlaces=", NoOfPlaces)
    for Count in range(0, NoOfPlaces):
      TempPlace = Place()
      TempPlace.ID = pickle.load(f)
      print("TempPlace.ID=", TempPlace.ID)
      TempPlace.Description = pickle.load(f)
      print("TempPlace.Description=", TempPlace.Description)
      TempPlace.North = pickle.load(f)
      print("TempPlace.North=", TempPlace.North)
      TempPlace.East = pickle.load(f)
      print("TempPlace.East=", TempPlace.East)
      TempPlace.South = pickle.load(f)
      print("TempPlace.South=", TempPlace.South)
      TempPlace.West = pickle.load(f)
      print("TempPlace.West=", TempPlace.West)
      TempPlace.Up = pickle.load(f)
      print("TempPlace.Up=", TempPlace.Up)
      TempPlace.Down = pickle.load(f)
      print("TempPlace.Down=", TempPlace.Down)
    ...
    for Count in range(0, NoOfItems):
      ...
      print("TempItem.Description=", TempItem.Description)
      TempItem.Status = pickle.load(f)
      print("TempItem.Status=", TempItem.Status)
      TempItem.Location = pickle.load(f)
      print("TempItem.Location=", TempItem.Location)
      TempItem.Name = pickle.load(f)
      print("TempItem.Name=", TempItem.Name)
      TempItem.Commands = pickle.load(f)
      print("TempItem.Commands=", TempItem.Commands)
      TempItem.Results = pickle.load(f)
      print("TempItem.Results=", TempItem.Results)
